					...
					<div class="w-full lg:w-8/12 flex flex-wrap">
						...
						<div class="w-full lg:w-6/12 px-4 self-center">
							<div class="relative w-full mb-3">
								...
								{#if treatmentGroups}
									<Select
										bind:value={review.treatmentGroup.value}
										bind:isValid={review.treatmentGroup.isValid}
						...
						<div class="w-full lg:w-6/12 px-4 self-center">
							<div class="relative w-full mb-3">
								...
								{#if treatments}
									<Select
										bind:value={review.treatment.value}
										bind:isValid={review.treatment.isValid}
										values={treatments}
										title={'Tedavi Seçin'}
										valuesKey={'_id'}
										valuesTitleKey={'name'}
