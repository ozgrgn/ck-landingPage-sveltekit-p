...
<textarea
class="border-0 p-2 placeholder:font-normal placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow  focus:outline-1 focus:outline-secondary  w-full {customClass} disabled:bg-slate-100"
bind:value
  {placeholder}
